...
public class MenuConfig {
    ...
    public static void main(String[] args) throws WxErrorException {
    	...
    	templateMessage.setToUser("o18jfvxHyS7uyYKrjhQYDOhwoOSc");
    	templateMessage.setTemplateId("XsGtNLToUo8fJvlJP_tRHaNcN3q2rJgyQ-s6FgU9IZg");
    	templateMessage.setUrl("https://www.baidu.com/");
    	templateMessage.setTopColor("#000000");
    	templateMessage.getData().add(new WxMpTemplateData("test", "你好", "#000000"));
    	MainConfig mainConfig = new MainConfig();
    	WxMpService wxMpService = mainConfig.wxMpService();
