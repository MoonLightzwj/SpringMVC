...
import com.zwj.util.MD5Util;
import com.zwj.util.ReturnModel;
import com.zwj.util.Sha1Util;
import com.zwj.util.XMLUtil;
...
public class PaymentController extends GenericController {
     ...
     * @throws Exception
     */
    public Map<String, String> enterprisePay(TreeMap<String, String> map,
        ...
        buffer.append("</xml>");
        String desc = new String(buffer.toString().getBytes("UTF-8"),
            "ISO-8859-1");
        ...
        try {
            ...
            try {
                ...
                if (entity != null) {
                    ...
                    returnMap = XMLUtil.parseXmlStringToMap(
                        new String(result.toString().getBytes(), "UTF-8"));//调用统一接口返回的值转换为XML格式
                }
